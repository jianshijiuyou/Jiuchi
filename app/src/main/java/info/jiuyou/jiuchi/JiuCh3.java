 ...
 */
@Deprecated
public class JiuCh3 extends View {
    ...
    public JiuCh3(Context context) {
        this(context, null);
    }

    public JiuCh3(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public JiuCh3(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
